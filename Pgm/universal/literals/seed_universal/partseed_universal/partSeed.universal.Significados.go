...
var O_Computador_entende = u.Significados{
	...
	Significados: []string{"somente binarios 0 e 1 onde 0 é falso", "circuito apagado e 1 é verdadeiro circuito acesso."},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}

var Linguagem_De_Programacao = u.Significados{
	Titulo:       "Linguagem_De_Programacao",
	Significados: []string{"Linguagem é o idioma onde criaremos o codigo fonte das nossas insyrucoes, e para o pc entender precisara de um interpretador ou um compilador para entregar ao pc em binario."},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}

var Linguagem_Compilada = u.Significados{
	Titulo:       "Linguagem_Compilada",
	Significados: []string{"Sao todas que cokpilamos o codigo fonte para binario, obs: as compiladas sao mais rapidas por ja entregarem em binario e o pc processa naturalmentevmais rapido.", "Ex: [ C, Golang, python, java,]"},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}

var Linguagem_Interpretada = u.Significados{
	Titulo:       "Linguagem_Interpretada",
	Significados: []string{"Sao todas que nao compilam para binario, para serem entendidas pelo pc precisa de um interpretador", "Ex: [ Javascript, typescript,  ]"},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}
var n = u.Significados{
	Titulo:       "lib",
	Significados: []string{"funcoes/modulos externas importaveis", "pacote", "Voce tem a liberdade de configurar do seu modo essa funcionalidade"},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}
var Framework = u.Significados{
	Titulo:       "Framework",
	Significados: []string{"Parece uma lib a diferenca que voce tem que usar esta lib/framework do jeito que ela foi programada para ser usada.", "voce tem que seguir suas regras de uso"},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}

var Caracteristicas = u.Significados{
	Titulo:       "Caracteristicas",
	Significados: []string{"Atributos", "Campos", "Propriedades Props", "key chave com valor", "Coisas que tenho?", "Posso ter?", "obs: os campos de estado serão: do tipo LOGICO boleano", ""},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}

var Comportamento = u.Significados{
	Titulo:       "Comportamento",
	Significados: []string{"Metodos", "Coisas que posso fazer?", "Funcao", "Metodo : funcao ligada a um objeto"},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}

var Estado = u.Significados{
	Titulo:       "Estado",
	Significados: []string{"Como estou agora?", "Estado_Atual"},
	Tutoriais:    []u.Tutoriais{{By: "#naoTem", Link: "#naoTem"}},
}

var Objeto = u.Significados{
	Titulo:       "Objeto",
	Significados: []string{"Tudo que tem : [ Caracteristicas, Comportamento, Estado]", "Instancia filho(s) instanciados apartir de uma estrutura", "Pode ser material (posso tocar) ou abstrato (nao posso tocar mas existe)", "Para criar um obj pergunte-se: [Coisas que tenho: Props, Coisas que faço: metodos, Como estou agora: Estado <sera uma caracterista do tipo LOGICO boleano]", "Todo objeto vem a apartir de um molde/classe/estrutura"},
